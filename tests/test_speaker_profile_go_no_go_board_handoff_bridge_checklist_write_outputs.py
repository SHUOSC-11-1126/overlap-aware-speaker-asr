...
from src.speaker_profile_go_no_go_board_handoff_bridge_checklist import (
...
class SpeakerProfileGoNoGoBoardHandoffBridgeChecklistWriteOutputsTest(unittest.TestCase):
    def test_write_outputs_emits_csv_json_and_markdown(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            root = Path(tmp_dir)
            with patch(
                "src.speaker_profile_go_no_go_board_handoff_bridge_checklist.PROJECT_ROOT",
                root,
            ):
