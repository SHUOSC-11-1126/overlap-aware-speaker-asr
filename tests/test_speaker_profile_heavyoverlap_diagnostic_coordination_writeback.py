...
from src.speaker_profile_heavyoverlap_diagnostic_coordination_writeback import (
...
class SpeakerProfileHeavyOverlapDiagnosticCoordinationWritebackTest(unittest.TestCase):
    ...
    def test_run_coordination_writeback_requires_wave12_closure(self) -> None:
        with patch(
            "src.speaker_profile_heavyoverlap_diagnostic_coordination_writeback.load_json_dict",
            side_effect=[
