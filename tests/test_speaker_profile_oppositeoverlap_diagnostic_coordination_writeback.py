...
from src.speaker_profile_oppositeoverlap_diagnostic_coordination_writeback import (
...
class SpeakerProfileOppositeOverlapDiagnosticCoordinationWritebackTest(unittest.TestCase):
    ...
    def test_run_coordination_writeback_requires_wave13_closure(self) -> None:
        with patch(
            "src.speaker_profile_oppositeoverlap_diagnostic_coordination_writeback.load_json_dict",
            side_effect=[
