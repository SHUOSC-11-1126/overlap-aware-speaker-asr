...
class FrontierExecutionQueueMilestoneBridgeChecklistTest(unittest.TestCase):
    def test_build_bridge_checklist_rows_links_milestone_to_dashboard(self) -> None:
        ...
        self.assertEqual(rows[0]["next_milestone"], "first_execution_queue_checkpoint_complete")
        self.assertIn("frontier_execution_queue_completion_dashboard.md", rows[0]["receipt_target"])
