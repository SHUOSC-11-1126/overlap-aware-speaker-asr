...
class SpeakerProfileEmbeddingTrialExecutionScaffoldReadinessBridgeChecklistWriteOutputsTest(unittest.TestCase):
    def test_write_outputs_emits_csv_json_and_markdown(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            root = Path(tmp_dir)
            with patch(
                "src.speaker_profile_embedding_trial_execution_scaffold_readiness_bridge_checklist.PROJECT_ROOT",
                root,
            ):
            ...
            self.assertIn(
                "Scaffold Readiness Bridge Checklist",
