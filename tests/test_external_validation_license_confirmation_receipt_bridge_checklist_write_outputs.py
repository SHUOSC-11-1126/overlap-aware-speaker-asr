...
class ExternalValidationLicenseConfirmationReceiptBridgeChecklistWriteOutputsTest(unittest.TestCase):
    def test_write_outputs_emits_csv_json_and_markdown(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            root = Path(tmp_dir)
            with patch("src.external_validation_license_confirmation_receipt_bridge_checklist.PROJECT_ROOT", root):
