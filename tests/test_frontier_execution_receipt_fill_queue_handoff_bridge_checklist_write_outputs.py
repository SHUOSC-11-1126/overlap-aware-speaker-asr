...
from src.frontier_execution_receipt_fill_queue_handoff_bridge_checklist import (
...
class FrontierExecutionReceiptFillQueueHandoffBridgeChecklistWriteOutputsTest(unittest.TestCase):
    def test_write_outputs_emits_csv_json_and_markdown(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            root = Path(tmp_dir)
            with patch(
                "src.frontier_execution_receipt_fill_queue_handoff_bridge_checklist.PROJECT_ROOT",
                root,
            ):
