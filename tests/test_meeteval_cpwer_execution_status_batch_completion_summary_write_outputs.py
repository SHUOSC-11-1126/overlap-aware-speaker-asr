...
from src.meeteval_cpwer_execution_status_batch_completion_summary import (
    COMPLETION_COLUMNS,
...
class MeetEvalCpwerExecutionStatusBatchCompletionSummaryWriteOutputsTest(unittest.TestCase):
    def test_write_outputs_emits_completion_summary_artifacts(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            root = Path(tmp_dir)
            with patch(
                "src.meeteval_cpwer_execution_status_batch_completion_summary.PROJECT_ROOT",
                root,
            ):
