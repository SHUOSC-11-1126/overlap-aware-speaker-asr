...
from src.wave17_speaker_profile_midoverlap_diagnostic_coordination_writeback import (
...
class Wave17SpeakerProfileMidOverlapDiagnosticCoordinationWritebackTest(unittest.TestCase):
    ...
    def test_run_coordination_writeback_requires_wave17_closure(self) -> None:
        with patch(
            "src.wave17_speaker_profile_midoverlap_diagnostic_coordination_writeback.load_json_dict",
            side_effect=[
