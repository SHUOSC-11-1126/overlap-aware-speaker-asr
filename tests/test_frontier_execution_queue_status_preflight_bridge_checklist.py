...
from src.frontier_execution_queue_status_preflight_bridge_checklist import (
    build_bridge_checklist_rows,
)


class FrontierExecutionQueueStatusPreflightBridgeChecklistTest(unittest.TestCase):
    def test_build_bridge_checklist_rows_links_dashboard_bridge_to_status(self) -> None:
        ...
        self.assertIn("runbook card target", rows[0]["bridge_note"])
