...
from src.frontier_execution_receipt_queue_milestone_card import (
    MILESTONE_COLUMNS,
...
class FrontierExecutionReceiptQueueMilestoneCardWriteOutputsTest(unittest.TestCase):
    def test_write_outputs_emits_csv_json_and_markdown(self) -> None:
        row = build_milestone_card_row(
            {"total_receipt_count": "3"},
            [
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            root = Path(tmp_dir)
            with patch(
                "src.frontier_execution_receipt_queue_milestone_card.PROJECT_ROOT",
                root,
            ):
            ...
            with csv_path.open("r", encoding="utf-8-sig", newline="") as handle:
                ...
                self.assertEqual(
                    ...
                    "first_receipt_queue_checkpoint_complete",
                )
