...
from src.meeteval_tokenization_adaptation_handoff_completion_summary import (
    COMPLETION_COLUMNS,
...
class MeetEvalTokenizationAdaptationHandoffCompletionSummaryWriteOutputsTest(unittest.TestCase):
    def test_write_outputs_emits_completion_summary_artifacts(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            root = Path(tmp_dir)
            with patch("src.meeteval_tokenization_adaptation_handoff_completion_summary.PROJECT_ROOT", root):
