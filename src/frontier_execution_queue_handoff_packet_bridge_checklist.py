...
def build_bridge_checklist_lines(rows: list[dict[str, str]]) -> list[str]:
    return [
        ...
        "",
        "This generated checklist turns the execution queue handoff packet into a bridge verification path. "
        ...
        *[
            ...
            f"{row['pending_chain_count']} | {row['prerequisite_artifact']} | {row['receipt_target']} | "
...
def write_outputs(rows: list[dict[str, str]]) -> tuple[Path, Path, Path]:
    ...
    csv_path = tables_dir / "frontier_execution_queue_handoff_packet_bridge_checklist.csv"
    json_path = tables_dir / "frontier_execution_queue_handoff_packet_bridge_checklist.json"
    md_path = figures_dir / "frontier_execution_queue_handoff_packet_bridge_checklist.md"
...
def main() -> None:
    ...
    print(
        "Wrote frontier execution queue handoff packet bridge checklist CSV: "
        f"{csv_path.relative_to(PROJECT_ROOT)}"
    )
    print(
        "Wrote frontier execution queue handoff packet bridge checklist JSON: "
        f"{json_path.relative_to(PROJECT_ROOT)}"
    )
    print(
        "Wrote frontier execution queue handoff packet bridge checklist note: "
