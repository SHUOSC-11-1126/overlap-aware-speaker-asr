...
PACKET_SECTIONS = [
    ...
    (
        "7",
        "tokenization_gain_scorecard_handoff_completion_summary",
        "results/figures/meeteval_cpwer_tokenization_gain_scorecard_handoff_completion_summary.md",
        "Completion rollup for the tokenization gain handoff path.",
    ),
    (
        "8",
        "tokenization_gain_scorecard_handoff_completion_summary_bridge_checklist",
        "results/figures/meeteval_cpwer_tokenization_gain_scorecard_handoff_completion_summary_bridge_checklist.md",
        "Verify gain handoff completion before advancing the tokenization adaptation handoff.",
    ),
    (
        "9",
