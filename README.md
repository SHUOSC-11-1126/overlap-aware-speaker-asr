...
- The packet now consolidates the whole top-level status/handoff subchain into one single-entry coordination artifact, including the operator brief, runbook, checkpoint, milestone, completion dashboard, and the newer `status_handoff_status` rollup layers.
