...
- The packet consolidates the top-level status snapshot, lane handoff, queue summary, bridge checkpoints, and the newer `status_handoff_status` rollup layer into one single-entry coordination artifact.
