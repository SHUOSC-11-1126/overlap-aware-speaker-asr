...
Stage 28 adds the AudioDepth-centric line: deployable mixed-only AudioDepth v2 maps, feature audit, lightweight embedding probes, a conservative Stage-1 acoustic gate, and a two-stage AudioDepth + text cascade. Stage 29/30 calibrate that gate and add a mixed-only risk guard; the current balanced policy reaches controlled_v2 CER `0.529082`, text-probe reduction `0.416667`, and direct-bypass false-safe `0.000000`. Stage 31 adds the final claim ledger, end-to-end safety audit, Stage-2 review guard, and presentation cards. Current evidence supports AudioDepth as a promising pre-ASR triage module, but not as a stable replacement for text instability routing.
...
- Go-no-go handoff packet: `results/tables/speaker_profile_go_no_go_handoff_packet.csv`
...
Update: `speaker_profile` now also has an execution receipt open card bridge checklist.

- Execution receipt open card bridge checklist: `results/tables/speaker_profile_embedding_trial_execution_receipt_open_card_bridge_checklist.csv`
- Execution receipt open card bridge checklist JSON: `results/tables/speaker_profile_embedding_trial_execution_receipt_open_card_bridge_checklist.json`
- Summary view: `results/figures/speaker_profile_embedding_trial_execution_receipt_open_card_bridge_checklist.md`
...
- This now consolidates the current receipt-readiness, receipt-open-card, handoff, operator-brief, runbook, checkpoint, milestone, completion-dashboard, and status-reentry path into one reusable entry packet plus a first-gate bridge, still without claiming any voiceprint success.

Update: `speaker_profile` now also has an execution receipt operator brief.

- Execution receipt operator brief: `results/tables/speaker_profile_embedding_trial_execution_receipt_operator_brief.csv`
- Execution receipt operator brief JSON: `results/tables/speaker_profile_embedding_trial_execution_receipt_operator_brief.json`
- Summary view: `results/figures/speaker_profile_embedding_trial_execution_receipt_operator_brief.md`
- Script: `python3 -m src.speaker_profile_embedding_trial_execution_receipt_operator_brief`
- This turns the handoff-packet bridge into a single plain-language next action for reopening the current speaker-profile readiness target, still without filling the receipt or claiming voiceprint success.

Update: `speaker_profile` now also has an execution receipt operator brief bridge.

- Execution receipt operator brief bridge: `results/tables/speaker_profile_embedding_trial_execution_receipt_operator_brief_bridge.csv`
- Execution receipt operator brief bridge JSON: `results/tables/speaker_profile_embedding_trial_execution_receipt_operator_brief_bridge.json`
- Summary view: `results/figures/speaker_profile_embedding_trial_execution_receipt_operator_brief_bridge.md`
...
Update: `speaker_profile` now also has an execution receipt phase checkpoint card.

- Execution receipt phase checkpoint card: `results/tables/speaker_profile_embedding_trial_execution_receipt_phase_checkpoint_card.csv`
- Execution receipt phase checkpoint card JSON: `results/tables/speaker_profile_embedding_trial_execution_receipt_phase_checkpoint_card.json`
- Summary view: `results/figures/speaker_profile_embedding_trial_execution_receipt_phase_checkpoint_card.md`
- Script: `python3 -m src.speaker_profile_embedding_trial_execution_receipt_phase_checkpoint_card`
- This narrows the current speaker-profile receipt runbook into one explicit completion signal for `NoOverlap`, still without filling the receipt or claiming voiceprint success.

Update: `speaker_profile` now also has an execution receipt phase checkpoint bridge checklist.

- Execution receipt phase checkpoint bridge checklist: `results/tables/speaker_profile_embedding_trial_execution_receipt_phase_checkpoint_bridge_checklist.csv`
- Execution receipt phase checkpoint bridge checklist JSON: `results/tables/speaker_profile_embedding_trial_execution_receipt_phase_checkpoint_bridge_checklist.json`
- Summary view: `results/figures/speaker_profile_embedding_trial_execution_receipt_phase_checkpoint_bridge_checklist.md`
- Script: `python3 -m src.speaker_profile_embedding_trial_execution_receipt_phase_checkpoint_bridge_checklist`
- This turns that phase checkpoint card into an explicit verification gate before reopening the current readiness artifact, still without claiming voiceprint success.

Update: `speaker_profile` now also has an execution receipt milestone card.

- Execution receipt milestone card: `results/tables/speaker_profile_embedding_trial_execution_receipt_milestone_card.csv`
- Execution receipt milestone card JSON: `results/tables/speaker_profile_embedding_trial_execution_receipt_milestone_card.json`
- Summary view: `results/figures/speaker_profile_embedding_trial_execution_receipt_milestone_card.md`
...
Update: `speaker_profile` now also has an execution receipt completion dashboard.

- Execution receipt completion dashboard: `results/tables/speaker_profile_embedding_trial_execution_receipt_completion_dashboard.csv`
- Execution receipt completion dashboard JSON: `results/tables/speaker_profile_embedding_trial_execution_receipt_completion_dashboard.json`
- Summary view: `results/figures/speaker_profile_embedding_trial_execution_receipt_completion_dashboard.md`
...
Update: `speaker_profile` now also has an execution receipt status preflight bridge checklist.

- Execution receipt status preflight bridge checklist: `results/tables/speaker_profile_embedding_trial_execution_receipt_status_preflight_bridge_checklist.csv`
- Execution receipt status preflight bridge checklist JSON: `results/tables/speaker_profile_embedding_trial_execution_receipt_status_preflight_bridge_checklist.json`
- Summary view: `results/figures/speaker_profile_embedding_trial_execution_receipt_status_preflight_bridge_checklist.md`
- Script: `python3 -m src.speaker_profile_embedding_trial_execution_receipt_status_preflight_bridge_checklist`
- This verifies the completion-dashboard bridge before reopening the machine-readable speaker-profile status rollup, still without claiming voiceprint success.

Update: `speaker_profile` now also has an execution receipt status reentry card.

- Execution receipt status reentry card: `results/tables/speaker_profile_embedding_trial_execution_receipt_status_reentry_card.csv`
- Execution receipt status reentry card JSON: `results/tables/speaker_profile_embedding_trial_execution_receipt_status_reentry_card.json`
- Summary view: `results/figures/speaker_profile_embedding_trial_execution_receipt_status_reentry_card.md`
- Script: `python3 -m src.speaker_profile_embedding_trial_execution_receipt_status_reentry_card`
- This reopens the machine-readable speaker-profile status rollup with one explicit reentry action after the status preflight bridge, still without filling the receipt or claiming voiceprint success.

Update: `speaker_profile` now also has an execution receipt status reentry bridge checklist.

- Execution receipt status reentry bridge checklist: `results/tables/speaker_profile_embedding_trial_execution_receipt_status_reentry_bridge_checklist.csv`
- Execution receipt status reentry bridge checklist JSON: `results/tables/speaker_profile_embedding_trial_execution_receipt_status_reentry_bridge_checklist.json`
- Summary view: `results/figures/speaker_profile_embedding_trial_execution_receipt_status_reentry_bridge_checklist.md`
- Script: `python3 -m src.speaker_profile_embedding_trial_execution_receipt_status_reentry_bridge_checklist`
- This verifies the speaker-profile status reentry card before reopening the receipt readiness target, still without filling the receipt or claiming voiceprint success.
...
Update: the frontier now also has a top-level completion dashboard.

- Frontier completion dashboard: `results/tables/frontier_operator_next_action_completion_dashboard.csv`
- Summary view: `results/figures/frontier_operator_next_action_completion_dashboard.md`
...
Update: the frontier now also has a top-level operator status handoff.

- Frontier operator status handoff: `results/tables/frontier_operator_next_action_status_handoff.csv`
- Summary view: `results/figures/frontier_operator_next_action_status_handoff.md`
...
Update: the frontier now also has a top-level operator status handoff completion summary.

- Frontier operator status handoff completion summary: `results/tables/frontier_operator_next_action_status_handoff_completion_summary.csv`
- Summary view: `results/figures/frontier_operator_next_action_status_handoff_completion_summary.md`
- Script: `python3 -m src.frontier_operator_next_action_status_handoff_completion_summary`
- Current evidence compresses the lane-specific top-level handoff into one queue-level row and currently records `queue_complete`.

Update: the frontier now also has a top-level operator status handoff completion summary bridge checklist.

- Frontier operator status handoff completion summary bridge checklist: `results/tables/frontier_operator_next_action_status_handoff_completion_summary_bridge_checklist.csv`
- Summary view: `results/figures/frontier_operator_next_action_status_handoff_completion_summary_bridge_checklist.md`
- Script: `python3 -m src.frontier_operator_next_action_status_handoff_completion_summary_bridge_checklist`
- Current evidence requires verifying the queue-level top-level handoff summary before the lane-level handoff is reopened.

Update: the frontier now also has a top-level operator status handoff packet.
...
- Current evidence requires verifying that packet before the plain-language `status/handoff` operator brief is reopened.
...
Update: the frontier now also has a top-level operator status handoff operator brief bridge.

- Frontier operator status handoff operator brief bridge: `results/tables/frontier_operator_next_action_status_handoff_operator_brief_bridge.csv`
- Summary view: `results/figures/frontier_operator_next_action_status_handoff_operator_brief_bridge.md`
...
Update: the frontier now also has a top-level operator status handoff runbook bridge checklist.

- Frontier operator status handoff runbook bridge checklist: `results/tables/frontier_operator_next_action_status_handoff_runbook_bridge_checklist.csv`
- Summary view: `results/figures/frontier_operator_next_action_status_handoff_runbook_bridge_checklist.md`
- Script: `python3 -m src.frontier_operator_next_action_status_handoff_runbook_bridge_checklist`
- Current evidence requires verifying that runbook card before the phase checkpoint card target is reopened.
...
Update: the frontier now also has a top-level operator status handoff milestone bridge checklist.

- Frontier operator status handoff milestone bridge checklist: `results/tables/frontier_operator_next_action_status_handoff_milestone_bridge_checklist.csv`
- Summary view: `results/figures/frontier_operator_next_action_status_handoff_milestone_bridge_checklist.md`
- Script: `python3 -m src.frontier_operator_next_action_status_handoff_milestone_bridge_checklist`
- Current evidence requires verifying that milestone card before the completion dashboard target is reopened.
...
Update: the frontier now also has a top-level operator status handoff status preflight bridge checklist.

- Frontier operator status handoff status preflight bridge checklist: `results/tables/frontier_operator_next_action_status_handoff_status_preflight_bridge_checklist.csv`
- Summary view: `results/figures/frontier_operator_next_action_status_handoff_status_preflight_bridge_checklist.md`
- Script: `python3 -m src.frontier_operator_next_action_status_handoff_status_preflight_bridge_checklist`
- Current evidence requires verifying the completion-dashboard bridge layer before the machine-readable status rollup target is reopened.
...
- Current evidence consolidates the execution queue status, queue summary, per-frontier handoff layers, the operator brief, the runbook card, the runbook bridge checklist, the phase checkpoint card, the milestone card, and the new completion dashboard into one single-entry artifact.
...
- Current evidence requires verifying the execution queue handoff packet before the execution queue operator brief is reopened.

Update: the frontier now also has an execution queue operator brief.

- Frontier execution queue operator brief: `results/tables/frontier_execution_queue_operator_brief.csv`
...
Update: the frontier now also has an execution queue runbook bridge checklist.

- Frontier execution queue runbook bridge checklist: `results/tables/frontier_execution_queue_runbook_bridge_checklist.csv`
- Summary view: `results/figures/frontier_execution_queue_runbook_bridge_checklist.md`
- Script: `python3 -m src.frontier_execution_queue_runbook_bridge_checklist`
- Current evidence requires verifying the execution queue runbook card before the current receipt target is reopened.

Update: the frontier now also has an execution queue phase checkpoint card.

- Frontier execution queue phase checkpoint card: `results/tables/frontier_execution_queue_phase_checkpoint_card.csv`
...
- Summary view: `results/figures/frontier_execution_queue_completion_dashboard.md`
...
Update: the frontier now also has an execution queue status reentry bridge checklist.

- Frontier execution queue status reentry bridge checklist: `results/tables/frontier_execution_queue_status_reentry_bridge_checklist.csv`
- Summary view: `results/figures/frontier_execution_queue_status_reentry_bridge_checklist.md`
- Script: `python3 -m src.frontier_execution_queue_status_reentry_bridge_checklist`
- Current evidence verifies the status reentry card before opening the execution queue handoff bridge.
...
Update: the frontier receipt layer now has a frontier bridge.

- Frontier bridge: `results/tables/frontier_execution_receipt_queue_frontier_bridge.csv`
- Frontier bridge JSON: `results/tables/frontier_execution_receipt_queue_frontier_bridge.json`
- Summary view: `results/figures/frontier_execution_receipt_queue_frontier_bridge.md`
- Script: `python3 -m src.frontier_execution_receipt_queue_frontier_bridge`
- This aligns the current receipt queue frontier with the breadth-first frontier queue head before downstream execution layers are reopened.

Update: the frontier receipt layer now has a frontier bridge checklist.

- Frontier bridge checklist: `results/tables/frontier_execution_receipt_queue_frontier_bridge_checklist.csv`
- Frontier bridge checklist JSON: `results/tables/frontier_execution_receipt_queue_frontier_bridge_checklist.json`
- Summary view: `results/figures/frontier_execution_receipt_queue_frontier_bridge_checklist.md`
...
Update: the frontier receipt layer now has an evidence receipt.

- Evidence receipt: `results/tables/frontier_execution_receipt_queue_evidence_receipt.csv`
- Evidence receipt JSON: `results/tables/frontier_execution_receipt_queue_evidence_receipt.json`
- Summary view: `results/figures/frontier_execution_receipt_queue_evidence_receipt.md`
- Script: `python3 -m src.frontier_execution_receipt_queue_evidence_receipt`
- This records what evidence the current receipt-queue frontier must write back before the execution receipt JSON stops being template-only.

Update: the frontier receipt layer now has an evidence receipt bridge checklist.

- Evidence receipt bridge checklist: `results/tables/frontier_execution_receipt_queue_evidence_receipt_bridge_checklist.csv`
- Evidence receipt bridge checklist JSON: `results/tables/frontier_execution_receipt_queue_evidence_receipt_bridge_checklist.json`
- Summary view: `results/figures/frontier_execution_receipt_queue_evidence_receipt_bridge_checklist.md`
...
Update: the frontier receipt layer now has a writeback open card bridge checklist.

- Writeback open card bridge checklist: `results/tables/frontier_execution_receipt_queue_writeback_open_card_bridge_checklist.csv`
- Writeback open card bridge checklist JSON: `results/tables/frontier_execution_receipt_queue_writeback_open_card_bridge_checklist.json`
- Summary view: `results/figures/frontier_execution_receipt_queue_writeback_open_card_bridge_checklist.md`
...
- Tokenization-to-fill bridge checklist: `results/tables/meeteval_tokenization_gain_to_frontier_fill_handoff_bridge_checklist.csv`
