...
Mode `logmel` achieved accuracy `0.7200` and macro-F1 `0.2791` on the held-out synthetic test split. Model status: `cnn`.

## Routing CER result
AudioDepth routing average CER was `0.436666` on `50` test samples.

## Comparison
- `audio_depth_cnn_logmel`: routing_average_cer `0.436666`
