...
| external_validation | documented_skill | docs/ambitious_research_agenda.md | external sanity-check note | Pick one external dataset, document license/source, and define the first output artifact. |
