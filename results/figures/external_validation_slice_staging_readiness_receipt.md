...
| --- | --- | --- | --- | --- |
| readiness_documented | single_short_meeting_excerpt | AISHELL-4 | not_ready | Staging readiness documented; external audio staging remains blocked until license confirmation is recorded. |
