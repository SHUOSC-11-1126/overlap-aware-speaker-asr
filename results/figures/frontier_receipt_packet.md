...
| --- | --- | --- | --- | --- |
| meeteval_compatibility | results/figures/meeteval_dry_run_handoff.md | results/tables/meeteval_dry_run_receipt.json | Open the handoff first, then write back to the receipt target after the narrow next step. | Coordination-only packet; not a claim of completed frontier execution. |
