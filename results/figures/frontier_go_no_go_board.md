...
| --- | --- | --- | --- | --- | --- |
| meeteval_compatibility | wave6_coordination_closure_complete | official_benchmark_claims_still_blocked_until_receipt_fill | go | If execution starts, use character-spaced cpWER and fill the official receipt with real evidence. | results/figures/meeteval_cpwer_tokenization_gain_scorecard_summary.md |
...
| demo_excellence | presentation_wave5_extension_complete | none_documented | go | Wave5 presentation extension complete; README/UI refresh remains qualitative/demo only. | results/figures/demo_go_no_go_summary.md |
