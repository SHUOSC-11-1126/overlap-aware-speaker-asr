...
| --- | --- | --- | --- | --- | --- |
| meeteval_compatibility | receipt_ready_to_fill | official_benchmark_claims_still_blocked_until_receipt_fill | go | If execution starts, use character-spaced cpWER and fill the official receipt with real evidence. | results/figures/meeteval_cpwer_tokenization_gain_scorecard_summary.md |
...
| demo_excellence | presentation_writeback_ready | live_demo_claims_still_blocked | go | Proceed only with a narrow presentation writeback or delivery mockup; do not claim a live demo, recording, or public presentation without filled evidence receipts. | results/figures/demo_go_no_go_summary.md |
