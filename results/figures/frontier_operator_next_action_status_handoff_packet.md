...
| 7 | status_handoff_status | results/figures/frontier_operator_next_action_status_handoff_status.md | Machine-readable status rollup for the current status/handoff queue state | Top-level operator status handoff packet section while queue_status=queue_complete, ready_lane_count=1, blocked_lane_count=1; no frontier execution is claimed. |
| 8 | status_handoff_status_bridge_checklist | results/figures/frontier_operator_next_action_status_handoff_status_bridge_checklist.md | Verify the status/handoff status rollup before reopening the broader status/handoff packet target | Top-level operator status handoff packet section while queue_status=queue_complete, ready_lane_count=1, blocked_lane_count=1; no frontier execution is claimed. |
