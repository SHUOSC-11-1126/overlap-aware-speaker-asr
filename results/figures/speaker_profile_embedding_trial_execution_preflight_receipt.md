...
| --- | --- | --- | --- | --- | --- |
| preflight_complete | single_case_embedding_execution_preflight | NoOverlap | embedding_or_voiceprint_baseline | True | Embedding execution preflight documented; voiceprint or embedding model execution remains pending. |
